    ...
    <div className="pt-30">
      ...
      <div className="cardSection flex pt-20">
        <div className="firstCard pr-10">
          ...
          <div className="pl-18 pt-4 w-100 text-gray-500 text-base text-truncate">
        ...
        <div className="border-l border-gray-300 h-70 ml-[-10px]"></div>
        <div className="secondCard pr-10">
          <img src="../../assets/Services/icon-design.svg" alt="" />
          <div className="pl-5 pt-25 text-2xl">Web Development</div>
          <div className="pl-5 pt-4 w-100 text-gray-500 text-base text-truncate">
            Our developers are carefully considering how your product should
            work while maintaining its flexibility.
          </div>
          <div className="pl-5 pt-10 text-red-500  ">Read More</div>
        </div>
        <div className="border-l border-gray-300 h-70 ml-[-10px]"></div>
        <div className="thirdCard">
          <img src="../../assets/Services/icon-design.svg" alt="" />
          <div className="pl-5 pt-25 text-2xl">SEO Optimization</div>
          <div className="pl-5 pt-4 w-100 text-gray-500 text-base text-truncate">
            Promotion of your product is an important step in making money and
            constant popularity among consumers.
          </div>
          <div className="pl-5 pt-5 text-red-500  ">Read More</div>
        </div>
      </div>
    </div>
  );
